...
export const ServiceModal = () => {
  const { selectedService, setSelectedService } = useContent();
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          background: 'linear-gradient(135deg, rgba(23, 55, 101, 0.9) 0%, rgba(11, 19, 43, 0.95) 100%)',
          ...
          <p style={{ fontSize: '1.1rem', color: '#E5E7EB', lineHeight: 1.6 }}>
        ...
        <div style={{ padding: '2.5rem' }}>
          ...
          <p style={{ fontSize: '1rem', color: '#cbd5e1', lineHeight: 1.7, marginBottom: '2.5rem' }}>
          ...
          <div style={{
            ...
            <div>
              <div style={{ fontSize: '0.85rem', color: '#cbd5e1' }}>Ready to implement this service?</div>
